...
def render_canonical_candidates(candidates: dict[str, list]) -> str:
    ...
    out = [
        ...
        '#',
        '# Each application below appears on more than one artefact.  Keep ONE rule',
        '# line per app (or several, for multiple golden versions) and comment (#)',
        '# or delete the rest, then pass this file via --canonical-sources.  A line',
