"""Add DFI artefact type

Revision ID: 000069e66a3f
Revises: 000069e53b12
Create Date: 2026-04-20
"""
import sqlalchemy as sa
from alembic import op

revision = '000069e66a3f'
down_revision = '000069e53b12'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    if bind.dialect.name == 'postgresql':
        op.execute(sa.text("ALTER TYPE artefacttype ADD VALUE IF NOT EXISTS 'DFI'"))
...
def downgrade():
    ...
    if bind.dialect.name != 'postgresql':
        return
    op.execute(sa.text(_CASCADE_SQL).bindparams(types=['DFI']))
