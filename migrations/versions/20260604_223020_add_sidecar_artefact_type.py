"""Add SIDECAR artefact type

Revision ID: 00006a21fc7c
Revises: 00006a1d3ed8
...
def upgrade():
    ...
    if bind.dialect.name == 'postgresql':
        op.execute(sa.text("ALTER TYPE artefacttype ADD VALUE IF NOT EXISTS 'SIDECAR'"))
...
def downgrade():
    ...
    if bind.dialect.name != 'postgresql':
        return
    op.execute(sa.text(_cascade_sql(['SIDECAR'])))
