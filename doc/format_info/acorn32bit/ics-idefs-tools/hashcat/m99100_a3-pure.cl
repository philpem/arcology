/**
 * m99100_a3-pure.cl — IDEFS hash, attack mode 3 (mask / brute-force)
 *
...
KERNEL_FQ void m99100_mxx (KERN_ATTR_VECTOR ())
{
...
KERNEL_FQ void m99100_sxx (KERN_ATTR_VECTOR ())
{
  const u64 gid = get_global_id (0);
