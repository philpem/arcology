...
ARCHIVE_EXTRACT    FORMAT_IDENTIFY       PRODUCT_RECOGNITION
DISC_MASTERING_DETECT  DISC_PROTECTION_DETECT  FORMAT_CONVERT
RISCOS_MODULE_PARSE   ARMLOCK_REMOVE     MEDIA_TRANSCODE
```
...
light:  CHECKSUM_COMPUTE, METADATA_EXTRACT, FORMAT_IDENTIFY,
        PRODUCT_RECOGNITION, DISC_MASTERING_DETECT,
...
services:
  worker-light:
    ...
    environment:
      ...
      - WORKER_ANALYSIS_TYPES=CHECKSUM_COMPUTE,METADATA_EXTRACT,FORMAT_IDENTIFY,PRODUCT_RECOGNITION,DISC_MASTERING_DETECT,DISC_PROTECTION_DETECT,ARMLOCK_REMOVE,RISCOS_MODULE_PARSE
    deploy:
      replicas: 2
      resources:
        limits:
        ...
        - name: worker
          ...
          env:
            ...
            - name: WORKER_ANALYSIS_TYPES
              value: "CHECKSUM_COMPUTE,METADATA_EXTRACT,FORMAT_IDENTIFY,PRODUCT_RECOGNITION,DISC_MASTERING_DETECT,DISC_PROTECTION_DETECT,ARMLOCK_REMOVE,RISCOS_MODULE_PARSE"
          resources:
            requests:
              cpu: "200m"
              memory: "256Mi"
